...
func = lambda x:math.sin(x) + math.cos(1 + x**2) - 1
# --- Ejercicio --- #
nIter = 4
...
func = lambda x: 7*math.sin(x)*E**(-x) - 1
dfunc = lambda x:7*E**(-x)*(math.cos(x) - math.sin(x))
...
print(Table)
print(func(7.212131e+24))
print(dfunc(7.212131e+24))